...
cd /var/www/html/red
aws s3 cp s3://${bucket_name}/hw-red.css ./
aws s3 cp s3://${bucket_name}/hw-red-py.css ./
aws s3 cp s3://${bucket_name}/python.png ./
aws s3 cp s3://${bucket_name}/apache.svg ./
aws s3 cp s3://${bucket_name}/red-index.html ./index.html
...
aws s3 cp s3://${bucket_name}/python.png ./
aws s3 cp s3://${bucket_name}/apache.svg ./
aws s3 cp s3://${bucket_name}/red-root-index.html ./index.html
